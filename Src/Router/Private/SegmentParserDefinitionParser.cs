/********************************************************************************
* SegmentParserDefinitionParser.cs                                              *
*                                                                               *
* Author: Denes Solti                                                           *
********************************************************************************/
using System;
...
namespace NanoRoute.Internals
{
    ...
    /// <summary>
    /// Parses parser-backed route segments and their optional argument list.
    /// </summary>
    internal static class SegmentParserDefinitionParser
    {
        ...
        /// TODO
        /// </summary>
        public static SegmentParserDefinition GetSegmentParserDefinition(string segment)
        {
            if (s_parserDefinitionParser.Match(segment) is not { Success: true } parsed)
                throw new ArgumentException(Resources.ERR_INVALID_PATTERN, nameof(segment));
            ...
            (
                parserName,
                ParseArguments(parsed.Groups["arguments"].Value),
                parsed.Groups["parameterName"].Value
            );
        }
    }
}