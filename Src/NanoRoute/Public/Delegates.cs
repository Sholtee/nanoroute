...
namespace NanoRoute
{
    ...
    /// </code>
    /// </example>
    public delegate TRouter RouterFactoryDelegate<TRouter, TConfig>(RouterBuilder<TRouter, TConfig> routerBuilder) where TRouter : RouterBase<TConfig> where TConfig : RouterConfig, new();
