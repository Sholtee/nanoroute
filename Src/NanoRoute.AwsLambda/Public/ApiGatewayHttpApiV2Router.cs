...
namespace NanoRoute.AwsLambda
{
    ...
    public sealed class ApiGatewayHttpApiV2Router : Router
    {
        ...
        /// <param name="remainingTime">The number of milliseconds left before the execution times out (can be fetched from the lambda context). Expired execution produces response with <see cref="HttpStatusCode.GatewayTimeout"/> status</param>
        ...
        public async Task<APIGatewayHttpApiV2ProxyResponse> Route(APIGatewayHttpApiV2ProxyRequest request, IServiceProvider services, TimeSpan remainingTime)
        {
            ...
            cts.CancelAfter(remainingTime.Add(TimeSpan.FromSeconds(-1)));
                ...
                return new APIGatewayHttpApiV2ProxyResponse
                {
                    ...
                    (
                        new ErrorDetails
                        {
                            ...
                            TraceId = (requestMessage.Properties[TRACE_ID_NAME] as string)!
                        },
