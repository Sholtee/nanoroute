...
For unsupported transports, compose the core `RequestPipeline` into a custom router and map your event model to `HttpRequestMessage` before calling `ExecuteAsync()`.
